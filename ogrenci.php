        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="forms-elements.php" class="active">
              <i class="bi bi-circle"></i><span>Form Ekleme</span>
            </a>
          </li>
    ...
    <section class = "section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Form istelleri</h5>

              <!-- General Form Elements -->
              <form action="DbBaglanti/ogrenci.php" method="POST" enctype="multipart/form-data" target="_blank">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Numara</label>
                  <div class="col-sm-10">
                    <input type="text" name="kulgirno" class="form-control" id="exampleInputName" placeholder="Numaranız">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">Başlangıç tarihi</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="tarih1">
                  </div>
                </div>
				<div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">Bitiş tarihi</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="tarih2">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Staj evrağını yükleyin</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">KONU</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 100px" name="mesaj"></textarea>
                  </div>
                </div>
				
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label">Gönder</label>
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" value="Tarih ön izleme" name="gonder">Gönder</button>
                  </div>
                </div>
